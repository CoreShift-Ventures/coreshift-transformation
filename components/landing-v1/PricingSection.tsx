      ...
      <div className="max-w-7xl mx-auto">
        ...
        >
          ...
          <h2 className={`text-3xl md:text-4xl font-bold mb-5 leading-[1.1] tracking-[-0.02em] ${isDark ? 'text-gray-100' : 'text-brand-charcoal'}`}>
            Fixed, Transparent Investment.<br />
            <span className="text-[#ec5f2b]">ROI in Months, Not Years.</span>
          </h2>
          <p className={`text-base max-w-3xl mx-auto font-light mb-8 ${isDark ? 'text-gray-400' : 'text-brand-gray'}`}>
            $30-60K implementation, not $500K+ surprise invoices. Choose the model that matches your transformation timeline.
          </p>
