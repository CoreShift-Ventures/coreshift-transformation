...
const blueprints = [
  {
    ...
    systems: ['NetSuite/SAP', 'BACS/SWIFT'],
  ...
  },
  {
    ...
    systems: ['SAP ECC/S4HANA', 'PostgreSQL'],
    buildTime: '4 to 6 weeks',
  ...
  },
  {
    ...
    systems: ['Tally Prime', 'PostgreSQL'],
...
const operationResponses: Record<string, { intro: string; points: string[]; closing: string }> = {
  ...
  'investor': {
    ...
    points: ['Data pull from Tally/accounting systems', 'FX rate integration', 'Formatted report generation'],
