    ...
    <section className={`relative min-h-screen flex items-center justify-center px-6 overflow-hidden ${isDark ? 'bg-black' : 'bg-white'}`}>
      ...
      <div className="relative max-w-5xl mx-auto z-10 text-center">
        ...
        <motion.h1
          ...
          className={`text-4xl md:text-5xl leading-[1.1] font-bold tracking-[-0.02em] mb-6 ${isDark ? 'text-gray-100' : 'text-brand-charcoal'}`}
        >
          <span>Own Your Post-Sales</span><br />
        ...
        <motion.p
          ...
          className={`text-base max-w-3xl mx-auto mb-10 font-light ${isDark ? 'text-gray-400' : 'text-brand-gray'}`}
        >
          Transform from firefighting to world-class post-sales. Start simple, unlock advanced features as you mature. Built to scale with your team.
        </motion.p>
