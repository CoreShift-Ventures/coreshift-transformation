...
import { TrendingUp, Target, Zap, Users, BarChart3, Shield, Heart, AlertTriangle, Activity, Brain, Sparkles, MessageSquare } from 'lucide-react';
...
const sections: FeatureSection[] = [
  ...
  },
  {
    ...
    subheading: 'ShiftIQ & CompassAI - Your intelligent co-pilots',
    features: [
      {
        icon: Brain,
        title: 'ShiftIQ - Predictive Analytics Engine',
        description: 'ML-powered insights that predict customer behavior, identify risk patterns, and surface opportunities 90 days in advance with 95% accuracy.',
        screenshot: '/screenshots/churn-prediction.png'
      },
      {
        icon: MessageSquare,
        title: 'CompassAI - Conversational Intelligence',
        description: 'Natural language interface to query your customer data, generate reports, and get instant answers. Ask "Which accounts are at risk?" and get actionable insights.',
        screenshot: '/screenshots/expansion-signals.png'
      },
      {
        icon: Sparkles,
        title: 'Automated Recommendations',
        description: 'AI-driven next best actions for every customer interaction - from personalized outreach to playbook suggestions, always backed by data.',
        screenshot: '/screenshots/revenue-forecasting.png'
      }
    ]
  }
                ...
                <div className="pl-6 cursor-pointer" onClick={() => setActiveFeature(index)}>
                  <div className="flex items-start gap-3">
                    <div className={`p-2 rounded-lg flex-shrink-0 ${
                      ...
                      <Icon
                        className={`w-4 h-4 ${isActive ? 'text-white' : isDark ? 'text-gray-400' : 'text-gray-600'}`}
                        strokeWidth={2}
                      />
                    </div>
        ...
        <AnimatePresence mode="wait">
          ...
          >
            <div className={`relative rounded-xl overflow-hidden ${
              isDark ? 'shadow-xl shadow-black/50' : 'shadow-xl shadow-gray-400/20'
                  ...
                  <div className="w-full h-full bg-gradient-to-br from-[#ec5f2b]/20 via-gray-900 to-gray-800 flex items-center justify-center">
                    <div className="text-center p-6">
                      {(() => {
                        ...
                        return <PlaceholderIcon className="w-16 h-16 text-[#ec5f2b]/40 mx-auto mb-3" strokeWidth={1} />;
                      })()}
                      <p className="text-gray-500 text-xs">Screenshot coming soon</p>
                    </div>
                  </div>
                )}
              </div>
